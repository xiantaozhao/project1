...
from ..utils import model_utils as utils, layers, normalization
...
class DDPM(nn.Module):
  def __init__(self, config):
    ...
    if conditional:
      ...
      modules[0].weight.data = default_initializer()(modules[0].weight.data)
      nn.init.zeros_(modules[0].bias)
      modules.append(nn.Linear(nf * 4, nf * 4))
      modules[1].weight.data = default_initializer()(modules[1].weight.data)
